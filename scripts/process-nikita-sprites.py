"""Process Nikita Funko pose sheet (7 frames) into game-ready sprites."""
...
def process_frame(frame: Image.Image, index: int) -> Image.Image:
    ...
    if index in PUNCH_FRAMES:
        y = max(0, TARGET_FRAME_H - nh - 44)
    else:
...
def main():
    ...
    preview.save(ROOT / "assets" / "pokemon" / "nikita-preview.png", optimize=True)
